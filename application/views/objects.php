                                    ...
                                    <tbody>
                                        ...
                                        <tr <?php if($i%2==1){ echo 'class="success"'; }?>>
                                            ...
                                            <td>
                                                ...
                                                <a onclick="window.location='<?php echo base_url(); ?>ArtifactType/edit/<?=$row['artifact_type_id']?>'">edit</a> <a onclick="confirm_del(<?=$row['artifact_type_id']?>)">delete</a>
                                            </td>
                                        </tr>
                                        <?php
                                        }?>
