                     ...
                     <div class="col-lg-12">
                         <div class="box">
                             ...
                             <div id="collapseOne" class="accordion-body collapse in body">
                                <?php echo form_open('event/add', 'class="form-horizontal" id="block-validate"'); ?>
                                 <!-- <form action="#" method="post" class="form-horizontal" id="block-validate"> -->
                                    <div class="form-group">
                                         ...
                                         <div class="col-lg-4">
                                             <input type="text" id="event_name" name="event_name" value="<?php echo set_value('event_name'); ?>"class="form-control" />
