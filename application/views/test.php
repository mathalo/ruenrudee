                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <?php echo form_open('search/test', 'role="form" id="block-validate"'); ?>
                                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div>
                                    <a href="<?php echo site_url()?>search/createxls"><i class="fa fa-file-excel-o"></i> Export Data</a>
                                </div>
                            </div>
                            <div class="panel-body">
                                            ...
                                            <tr <?php if($i%2==1){ echo 'class="success"'; }?>>
                                                ...
                                                <td>
                                                    <a onclick="window.location='<?php echo base_url(); ?>search/detail/<?=$row['artifact_id']?>'">
                                                        <button class="btn btn-primary"><i class="icon-search icon-white"></i> ดูราบละเอียด</button>
                                                    </a> 
                                                </td>
                                            </tr>
                                                <?php
