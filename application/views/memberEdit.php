                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <div  class="fileupload fileupload-new" data-provides="fileupload">
                                            ...
                                            <div>
                                                <span class="btn btn-file btn-success"><span class="fileupload-new">เลือกรูปภาพ image</span><span class="fileupload-exists">เปลี่ยนรูป</span><input type="file" name="filename"/></span>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <a href="<?php echo base_url(); ?>Members/cpassword/<?php echo $row['member_id'];?>">Change Password!!!</a>
