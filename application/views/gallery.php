        ...
        <div id="content">
            ...
            <div class="inner">
                <div class="row">
                    <div class="col-lg-12">
                        <h2>Gallery File Upload Demo</h2>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ตารางข้อมูลโบราณวัตถุ ศิลปวัตถุ
                    </div>
                        ...
                        <div class="table-responsive">
                            <!-- The file upload form used as target for the file upload widget -->
                                <form id="fileupload" action="https://jquery-file-upload.appspot.com/" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row fileupload-buttonbar">
                                        <div class="col-lg-7">
                                            ...
                                            <span class="btn btn-success fileinput-button">
                                                ...
                                                <input type="hidden" name="countImg" >                        
                                            </span>
                                    ...
                                    <button  type="button" id="example-10" class="btn btn-primary ForMargin" onclick="window.location='<?php echo base_url(); ?>Artifact/'">ย้อนกลับ</button>
                                </form>
                        </div>
                    </div>
    ...
    <script id="template-upload" type="text/x-tmpl">
        ...
        <tr class="template-upload fade">
            ...
            <td>
                ...
                <input type="text" name="fileupload{%=countImg%}" value="{%=file.name%}">
        ...
        %}
        <!-- <input type="text" name="allimg" value="{%=countImg%}"> -->
